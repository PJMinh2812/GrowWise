...
export function DownloadCTA() {
  return (
    <section id="download" className="py-16 sm:py-24 bg-background">
            ...
            <div className="grid lg:grid-cols-2 gap-10 items-center">
              ...
              <div className="text-center lg:text-left">
                ...
                <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                  <a
                    href="#"
                    className="inline-flex items-center justify-center gap-3 bg-foreground text-background px-6 py-3.5 rounded-xl hover:bg-foreground/90 transition-colors"
                  >
              ...
              <div className="flex justify-center lg:justify-end">
                <div className="relative">
                  ...
                  <div className="absolute -bottom-6 -right-6 w-32 h-32 bg-secondary/40 rounded-full blur-xl" />

                  {/* Phone */}
                  <div className="relative bg-white/20 backdrop-blur-sm rounded-[2rem] p-4 border border-white/30">
                    <div className="bg-card rounded-[1.5rem] p-6 w-[200px] sm:w-[240px]">
                      ...
                      <div className="text-center">
                        <h3 className="font-bold text-foreground text-lg">GrowWise</h3>
                        <p className="text-sm text-muted-foreground mt-1">Tài chính thông minh cho trẻ</p>
                      </div>
                      <div className="mt-6 flex items-center justify-center gap-2">
                        <Smartphone className="w-5 h-5 text-primary" />
                        <span className="text-sm font-medium text-primary">Tải ngay!</span>
                      </div>
                    </div>
                  </div>
                </div>
