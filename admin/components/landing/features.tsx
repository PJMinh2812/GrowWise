          ...
          {features.map((feature, index) => (
            ...
            >
              ...
              <div className={`w-14 h-14 ${feature.bgColor} rounded-2xl flex items-center justify-center mb-5 group-hover:scale-110 transition-transform`}>
                <feature.icon className={`w-7 h-7 ${feature.color === "bg-primary" ? "text-primary" : feature.color === "bg-secondary" ? "text-secondary" : feature.color === "bg-foreground" ? "text-foreground" : "text-accent-foreground"}`} />
              </div>
