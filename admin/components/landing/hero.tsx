  ...
  return (
    <section className="relative overflow-hidden py-16 sm:py-24 lg:py-32">
      ...
      <div className="absolute inset-0 -z-10">
        ...
        <div className="absolute top-40 right-20 w-32 h-32 bg-primary/20 rounded-full blur-3xl" />
        <div className="absolute bottom-20 left-1/4 w-24 h-24 bg-accent rounded-full blur-2xl" />
      </div>
