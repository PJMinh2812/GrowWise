        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            <Link href="/" className="flex items-center gap-2 mb-4">
              ...
              <span className="font-bold text-xl text-background">GrowWise</span>
            </Link>
          ...
          {/* Links */}
          <div>
            <h4 className="font-semibold text-background mb-4">Sản phẩm</h4>
            <ul className="space-y-3">
              ...
              <li>
                <Link href="#download" className="text-background/70 hover:text-background transition-colors text-sm">
                  Tải ứng dụng
                </Link>
              </li>
            </ul>
          ...
          <div>
            <h4 className="font-semibold text-background mb-4">Pháp lý</h4>
            <ul className="space-y-3">
              <li>
                <Link href="#" className="text-background/70 hover:text-background transition-colors text-sm">
                  Điều khoản sử dụng
